    ...
    <Animated.View style={[styles.skeletonWrapper, { opacity }]}>
      ...
      <View style={styles.skeletonBody}>
        ...
        <View
          style={[
            styles.skeletonLine,
            { width: "35%", height: 20, backgroundColor: "#fecaca" },
          ]}
        />
...
export const ProductDetailScreen: React.FC = () => {
  ...
  const addItem = useAuthStore(
    (state) => (state as any).addItem as ((item: any) => void) | undefined,
  );
        ...
        >
          ...
          >
            <View style={styles.heroWrapper}>
              ...
              />
              <View
                style={[styles.stockPill, isOutOfStock && styles.stockPillOut]}
              >
                <View
                  style={[styles.stockDot, isOutOfStock && styles.stockDotOut]}
                />
                <Text
                  style={[
                    styles.stockPillText,
                    isOutOfStock && styles.stockPillTextOut,
                  ]}
                >
                  {isOutOfStock
                    ? "Hết hàng"
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.metaRow}>
                <Text style={styles.store}>
                  🏪 {product.seller?.storeName || "Cửa hàng"}
                </Text>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: "#f3f7f1" },
  content: { gap: 14, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 32 },
  heroWrapper: {
    position: "relative",
    borderRadius: 24,
    overflow: "hidden",
  ...
  stockPillOut: { backgroundColor: "#fff1f2", borderColor: "#fecaca" },
  stockDot: {
    width: 7,
    height: 7,
    borderRadius: 4,
  ...
  stockDotOut: { backgroundColor: "#dc2626" },
  stockPillText: { fontSize: 12, fontWeight: "700", color: "#15803d" },
  stockPillTextOut: { color: "#dc2626" },
  infoCard: {
  ...
  title: { color: "#0f172a", fontSize: 26, lineHeight: 33, fontWeight: "900" },
  metaRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  },
  store: { color: "#64748b", fontSize: 14, flex: 1 },
  ratingBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 3,
  ...
  ratingNum: { color: "#92400e", fontWeight: "700", fontSize: 14 },
  divider: { height: 1, backgroundColor: "#f0fdf4", borderRadius: 1 },
  price: {
    color: "#b91c1c",
    fontSize: 28,
    fontWeight: "900",
  ...
  descLabel: { color: "#0f172a", fontWeight: "800", fontSize: 17 },
  description: { color: "#334155", lineHeight: 22, fontSize: 14 },
  actionCard: { gap: 10 },
  addCartBtn: {
    backgroundColor: "#16a34a",
    borderRadius: 16,
  ...
  addCartBtnPressed: { opacity: 0.88, transform: [{ scale: 0.98 }] },
  addCartText: { color: "#ffffff", fontWeight: "800", fontSize: 17 },
  backBtn: {
    borderRadius: 16,
    paddingVertical: 14,
    alignItems: "center",
  ...
  backText: { color: "#15803d", fontWeight: "700", fontSize: 15 },
